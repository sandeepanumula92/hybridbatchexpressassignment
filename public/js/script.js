...
$.ajax({
  ...
  success: function(dataFromServer){
    data=$.parseJSON(dataFromServer);
  //  alert(data[0].Title);
    $.each(data, function(index, value) {
      output+='<div class="col-md-4">'+'<br/><br/><img id="bgposter"  alt="Bootstrap Image Preview" src="'+ data[index].Poster +'" class="img-rounded center-block"></div><div class="col-md-8"><br/><br/><h3>'
      ...
      '<br/></br><button class="buttonupdate" type="button" id="'+value.Title
          +"|"+value.Year+"|"+value.Actors+"|"+value.Director+"|"+value.Plot+"|"+value.Poster+"|"+value.imdbRating+"|"+value.Awards+"|"+value.Released+"|"+value.Language+"|"+value.Country+'" data-toggle="modal" data-target="#myModalHorizontal">Update</button> '+
              ...
              '&nbsp;<button data-toggle="modal" data-target="#myModalDeleteAlert" class="buttonDelete " id="'+value.Title+'" type="button"><em class="glyphicon glyphicon-delete"></em> Delete'+
